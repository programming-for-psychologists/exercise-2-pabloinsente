'''
8. Extend the task by requiring the subject to respond by 
pressing a spacebar (the key is called 'space'), 
as quickly as possible anytime the name on the screen
matches the name you entered into the box 
(so if I enter 'Gary' I would have to press 'space' 
anytime the name 'Gary' shows up. 
If the participant presses 'space' to the wrong name (false alarm),
